...
```{r dvs-4-2}
# Challenge 3 (Question 5.1.1 Male vs. Female, Revised to use latest across)
...
Despite showing proficiency in most of the learning targets, I still face some issues such as lacking plot labels and code repetition. This can be seen in my earlier labs where I failed to put proper axis labels. There was also a lot of repeating and inefficient code in my initial Lab 3 submission. Because of proper feedback, I was able to revise my thinking and apply the feed backs I received in my future lab assignments. I use my Lab 5 Time Plot as a reference to clear and readable plots, and believe that to be my cleanest and favorite one. Additionally, after receiving the efficiency feedback in Lab 3, I began to take it into more consideration. When summarizing data across columns greater than 2, I utilize the `across()` helper to avoid repetition (this was done through a Challenge revision). I have also continued to show improvement and learning in this aspect through my Lab 4 when I used `%in%` when filtering multiple categories in a specific column. Overall, I believe to have demonstrated a proficiency in revised thinking throughout the entirety of the course. I take each feedback from my professor and peers into account in order to avoid making the same mistakes in the future. I have also always made sure to submit a revision each week despite having only minor issues with my code.
